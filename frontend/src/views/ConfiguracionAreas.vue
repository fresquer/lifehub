  ...
  <div class="page">
    <header class="topbar">
      <div class="topbar-left">
        ...
        <span class="page-title">Configuración áreas</span>
      </div>
...
.brand { font-weight: 700; font-size: 1.15rem; color: #e2e8f0; text-decoration: none; }
.brand:hover { color: #f8fafc; }
.page-title { font-size: 0.95rem; color: #94a3b8; font-weight: 500; }
...
.dropdown-chevron { font-size: 0.7rem; color: #64748b; transition: transform 0.2s; }
...
.dropdown-name { font-weight: 600; font-size: 0.95rem; color: #f1f5f9; }
.dropdown-email { font-size: 0.8rem; color: #94a3b8; }
.dropdown-divider { height: 1px; background: rgba(255, 255, 255, 0.08); margin: 0.25rem 0; }
...
.dropdown-icon { font-size: 1rem; opacity: 0.9; }
